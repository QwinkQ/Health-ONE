...
- [Mealie](https://github.com/mealie-recipes/mealie)：自托管菜谱管理、Meal Plan、购物清单、REST API。
- [Tandoor Recipes](https://github.com/TandoorRecipes/recipes)：菜谱管理、餐食计划、购物清单。
- [Grocy](https://github.com/grocy/grocy)：冰箱、家庭库存、保质期、购物管理，参考“根据剩余食材推荐”。
- [RecipeSage](https://github.com/julianpoy/RecipeSage)：PWA、菜谱保存、Meal Plan、购物清单、营养追踪。
- [PANTS](https://github.com/dylanleigh/PriceAndNutritionTrackingSystem)：开源营养追踪和菜谱营养分析，参考营养计算。
- [mealie-cli](https://github.com/jez500/mealie-cli)：把 Mealie 做成 CLI / MCP 风格工具，Agent 工具调用设计。
